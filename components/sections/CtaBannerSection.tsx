		...
		<section
			className={cn(
				...
				isEmergency
					...
					: isPromo
					? 'bg-linear-to-r from-(--template-secondary) to-(--template-primary)'
					: 'bg-linear-to-r from-(--template-primary) to-(--template-secondary)',
				className
			)}
		>
			{/* Background Pattern */}
					...
					<div className="flex flex-col sm:flex-row items-center gap-4">
						...
						{isEmergency && phone && (
							<a
								href={`tel:${phone}`}
								className={cn(
									'inline-flex items-center gap-3 px-6 py-4 rounded-lg',
									'bg-white text-rose-600 font-bold text-lg',
						...
						{!isEmergency && (
							<TemplateButton
								...
								size="lg"
								href={ctaHref}
								className="bg-white text-(--template-primary) hover:bg-white/90"
							>
								{ctaText}
								<svg
									className="w-5 h-5"
