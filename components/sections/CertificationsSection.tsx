...
const CertificationBadge = ({
  ...
  const iconVariants = [
    ...
    <svg key="badge" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <svg key="award" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <svg key="cert" className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
